  ...
  return (
    <div style={{ backgroundColor: bgColor, color: color}} id="container">
      <header>
        ...
        <div id="app-header">
          <h1>
            <Link to="/notes">Motion</Link>
          </h1>
          <h6 id="app-moto">Like Notion, but cooler.</h6>
        </div>
        <aside>&nbsp;</aside>
        <button style={{width:"75px", color:color}} onClick={handleButtonClick}>&#9681;</button>
      </header>
      ...
      <footer style={{textAlign:"center"}}>@bymasroor</footer>
    </div>
  );
}
